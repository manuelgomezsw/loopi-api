...
**All SDD workflow output must be in Spanish (es-CO).**

This applies to: spec.md, plan.md, tasks.md, research.md, data-model.md, checklists, and all user-facing messages generated by `/speckit-*` commands. Code, identifiers, and technical strings (variable names, file paths, SQL) remain in English.
